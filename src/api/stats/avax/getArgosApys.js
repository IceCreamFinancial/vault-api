...
const pools = require('../../../data/avax/argosLpPools.json');
import { joeClient } from '../../../apollo/client';
import { JOE_LPF } from '../../../constants';

const getArgosApys = async () =>
  await getMasterChefApys({
    web3: web3,
    chainId: chainId,
    masterchef: '0xf2A6775EdF1595184E5BaD29b6EC0dA4D5AB15fD',
